...
import me.zachbears27.Database;
...
//		System.out.println("[MySQL] Connecting to: " + connectionURL);
        Class.forName("com.mysql.jdbc.Driver");
        connection = DriverManager.getConnection(connectionURL, this.user, this.password);
        if(connection == null) {
        	System.out.println("[MySQL] DeathLocations: Failed");
        } else {
        	System.out.println("[MySQL] DeathLocations: Connected");
        }
		return connection;
	}
}
